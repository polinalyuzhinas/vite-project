...
template_PolygonFeature([[[239, 1409], [306, 1409], [306, 1325], [239, 1325], [239, 1409]]], '300 (находится между 3 и 4 этажами)', '300',
    ...
    { day: 'Понедельник', number: '4', department: ['КНиИТ', 'ФМиЕНД'], group: ['331', '311', '321', '341', '351', '381', '321'], teacher: 'Косарева С.А.', lesson: 'Английский язык (переводчики) 4 гр.', type: 'пр.', parity: '-'},
    ...
    { day: 'Вторник', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Уколова М.В.', lesson: 'Английский язык (переводчики) 4 гр.', type: 'пр.', parity: '-'},
...
template_PolygonFeature([[[1166, 631], [1361, 631], [1361, 373], [1166, 373], [1166, 631]]], '402 (компьютерный класс экономического факультета)', '402',
    [{ day: 'Понедельник', number: '4', department: ['КНиИТ', 'ФМиЕНД'], group: ['331', '311', '321', '341', '351', '381', '321'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 1 гр.', type: 'пр.', parity: '-'},
    { day: 'Понедельник', number: '5', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '421'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 2 гр.', type: 'пр.', parity: '-'},
    { day: 'Вторник', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 1 гр.', type: 'пр.', parity: '-'},
    { day: 'Вторник', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 1 гр.', type: 'пр.', parity: '-'},
    { day: 'Среда', number: '3', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '421'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 2 гр.', type: 'пр.', parity: '-'},
    { day: 'Среда', number: '4', department: ['КНиИТ', 'ФМиЕНД'], group: ['331', '311', '321', '341', '351', '381', '321'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 1 гр.', type: 'пр.', parity: '-'},
    { day: 'Четверг', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 1 гр.', type: 'пр.', parity: '-'},
    { day: 'Четверг', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Алексеева Д.А.', lesson: 'Английский язык (переводчики) 1 гр.', type: 'пр.', parity: '-'}]);
...
template_PolygonFeature([[[2894, 1318],[3193, 1318],[3193, 932],[2894, 932],[2894, 1318]]], '426', '426', 
    ...
    { day: 'Понедельник', number: '5', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '481', '421'], teacher: 'Косарева С.А.', lesson: 'Английский язык (переводчики) 4 гр.', type: 'пр.', parity: '-'},
    ...
    { day: 'Вторник', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Карпец Е.В.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-'},
    ...
    { day: 'Среда', number: '3', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '481', '421'], teacher: 'Уколова М.В.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-' },
    { day: 'Среда', number: '5', department: 'КНиИТ', group: ['341'], teacher: 'Сафрончик М.И.', lesson: 'Базы данных 2 гр.', type: 'пр.', parity: '-' },
    { day: 'Четверг', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Косарева С.А.', lesson: 'Английский язык (переводчики) 5 гр.', type: 'пр.', parity: '-' },
    { day: 'Четверг', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Косарева С.А.', lesson: 'Английский язык (переводчики) 5 гр.', type: 'пр.', parity: '-'},
