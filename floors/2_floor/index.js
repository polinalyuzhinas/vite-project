...
template_PolygonFeature([[[1998, 635], [2230, 635], [2230, 373], [1998, 373], [1998, 635]]], '230 (лаборатория аудиовизуальных средств обучения, <br> компьютерный класс)', '230',
    ...
    { day: 'Понедельник', number: '4', department: ['КНиИТ', 'ФМиЕНД'], group: ['331', '311', '321', '341', '351', '381', '321'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-'},
    { day: 'Понедельник', number: '5', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '481', '421'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 5 гр.', type: 'пр.', parity: '-'},
    { day: 'Вторник', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Косарева C.А.', lesson: 'Английский язык (переводчики) 1 гр.', type: 'пр.', parity: '-'},
    { day: 'Вторник', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Косарева C.А.', lesson: 'Английский язык (переводчики) 5 гр.', type: 'пр.', parity: '-'},
    ...
    { day: 'Среда', number: '3', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '481', '421'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 5 гр.', type: 'пр.', parity: '-'},
    { day: 'Среда', number: '4', department: ['КНиИТ', 'ФМиЕНД'], group: ['331', '311', '321', '341', '351', '381', '321'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-'},
    ...
    { day: 'Четверг', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Карпец Е.В.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-' },
    { day: 'Четверг', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Уколова М.А.', lesson: 'Английский язык (переводчики) 4 гр.', type: 'пр.', parity: '-'},
...
template_PolygonFeature([[[2507, 635],[2749, 635],[2749, 373],[2507, 373],[2507, 635]]], '228 (лаборатория информационных <br> технологий 1, компьютерный класс)', '228', 
    ...
    { day: 'Пятница', number: '5', department: 'ФМиЕНД', group: ['220'], teacher: 'Векслер В.А.', lesson: 'Непрерывное профессиональное образование в сфере информационных технологий', type: 'лек.', parity: 'пр.'},]);
...
template_PolygonFeature([[[1915, 1097], [2148, 1097], [2148, 778], [1915, 778], [1915, 1097]]], '215 (лаборатория информационных технологий 3, компьютерный класс)', '215',
    ...
    { day: 'Понедельник', number: '5', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '481', '421'], teacher: 'Уколова М.А.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-'},
    { day: 'Понедельник', number: '6', department: 'КНиИТ', group: ['341'], teacher: 'Щуров Д.И.', lesson: 'Java-программирование 1 гр.', type: 'пр.', parity: '-'},
    { day: 'Вторник', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-'},
    { day: 'Вторник', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 2 гр.', type: 'пр.', parity: '-'},
    ...
    { day: 'Среда', number: '3', department: ['КНиИТ', 'ФМиЕНД'], group: ['431', '441', '421', '411', '451', '481', '421'], teacher: 'Косарева C.А.', lesson: 'Английский язык (переводчики) 4 гр.', type: 'пр.', parity: '-'},
    { day: 'Среда', number: '4', department: ['КНиИТ', 'ФМиЕНД'], group: ['331', '311', '321', '341', '351', '381', '321'], teacher: 'Косарева C.А.', lesson: 'Английский язык (переводчики) 4 гр.', type: 'пр.', parity: '-'},
    ...
    { day: 'Четверг', number: '1', department: ['КНиИТ', 'ФМиЕНД'], group: ['221', '241', '221'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 2 гр.', type: 'пр.', parity: '-'},
    { day: 'Четверг', number: '2', department: ['КНиИТ', 'ФМиЕНД'], group: ['121', '141', '181', '121'], teacher: 'Павлова О.В.', lesson: 'Английский язык (переводчики) 3 гр.', type: 'пр.', parity: '-'},
